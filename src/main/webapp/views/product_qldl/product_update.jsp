...
<body>
	<div class="container pt-3">
		<h1 style="text-align: center;">Điền thông tin cập nhập sản phẩm</h1>
		<f:form action="/Java5_SOF3021_Assignment/product/update_product" method="POST" modelAttribute="product">
			<!--  <div class="row">
			...
			<div class="row">
				<div class="form-group">
						...
						<label><f:radiobutton name="available" value="0" path="available"/>Còn hàng</label>
			...
			<div class="row">
				<div class="form-group">
					...
					<f:select class="form-select" path="category" >
						<f:options items="${categories}" itemValue="id" itemLabel="name"></f:options>
					</f:select>
				</div>
			</div>

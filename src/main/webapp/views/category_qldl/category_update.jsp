...
<head>
<meta charset="UTF-8">
<title>Cập nhập loại hàng</title>
<link
...
<body>
	<div class="container pt-3">
		<h1 style="text-align: center;">Điền thông tin cập nhập loại hàng</h1>
		<f:form action="/Java5_SOF3021_Assignment/category/update_category" method="POST" modelAttribute="category">
			<f:hidden path="id" />
			<div class="row">
